...
@section('content')
<div class="max-w-2xl">
    <h2 class="text-2xl font-bold text-white mb-6">Create New Company</h2>

    <form method="POST" action="{{ route('admin.companies.store') }}" class="bg-gray-800 rounded-lg p-6 space-y-6">
        @csrf
